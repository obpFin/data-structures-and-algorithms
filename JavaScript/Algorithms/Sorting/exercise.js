const bubbleSort = 'bubble sort'
const selectionSort = 'Selection sort'
const insertionSort = 'Insertion sort'
const radixSort = 'Radix sort'
const countingSort = 'Counting sort'
